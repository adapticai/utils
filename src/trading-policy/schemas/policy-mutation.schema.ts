 ...
 */
export const PolicyMutationSchema = z
  .object({
    ...
    signalConsumptionPrefs:
      SignalConsumptionPrefsObjectSchema.deepPartial().optional(),
    executionPrefs: ExecutionPrefsObjectSchema.deepPartial().optional(),
    positionManagementPrefs:
      PositionManagementPrefsObjectSchema.deepPartial().optional(),
    portfolioConstructionPrefs:
      PortfolioConstructionPrefsObjectSchema.deepPartial().optional(),
    overlayResponsePrefs:
      OverlayResponsePrefsObjectSchema.deepPartial().optional(),
    modelPrefs: ModelPrefsObjectSchema.deepPartial().optional(),
    auditNotificationPrefs:
      AuditNotificationPrefsObjectSchema.deepPartial().optional(),
  })
  .passthrough();
