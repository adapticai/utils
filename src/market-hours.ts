...
export const marketEarlyCloses: MarketEarlyCloses = {
  ...
  2027: {
    "2027-11-26": {
      ...
      optionsTime: "13:15",
      notes:
        "Market closes early on Friday, November 26, 2027 at 1:00 p.m. (1:15 p.m. for eligible options). NYSE American Equities, NYSE Arca Equities, NYSE National, and NYSE Texas late trading sessions will close at 5:00 p.m. Eastern Time.",
    },
  },
};
